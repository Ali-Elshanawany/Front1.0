...
$('.homeNav').on("click",function(){ window.location.href = "/html/SellerHome.html";})
$('.productNav').on("click",function(){window.location.href="/html/SellerHome.html#product"})
$('.contactNav').on("click",function(){window.location.href="/html/SellerHome.html#contact"})
$('.aboutNav').on("click",function(){window.location.href="/html/SellerHome.html#about"})